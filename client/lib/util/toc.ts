...
interface ReactElementWithChildren<T = React.ReactNode> extends React.ReactElement {
...
export function convertElementToHtml<T = React.ReactNode>(
  ...
  const children = Array.isArray(props.children) ? props.children : [props.children] // Ensure children is always an array
