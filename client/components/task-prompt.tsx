...
const TaskPrompt = ({ onClose }: PromptLineProps) => {
  ...
  return (
    <>
      <Input
        ...
        placeholder="Eg. Doctor appointment tomorrow at 2 pm"
        className="border-none"
      />
      <TaskPreview task={task} />
      <div className="flex-gap">
        <Button onClick={sendPrompt} variant={'secondary'}>
          Create Task
        </Button>
        <Button onClick={clearPrompt} variant={'ghost'}>
          Clear
        </Button>
