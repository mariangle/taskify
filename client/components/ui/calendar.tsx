...
function Calendar({ className, classNames, tasks, showOutsideDays = true, ...props }: CalendarProps & CustomProps) {
  function CalendarDateItem(props: DayContentProps & CustomProps) {
    const hasSameDate = props.tasks?.some((task) => task.dueDate && isSameDay(new Date(task.dueDate), props.date))
