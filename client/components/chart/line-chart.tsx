  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Visualizing the trend of completed tasks over time.</CardDescription>
      </CardHeader>
                    ...
                    return (
                      <div className="rounded-lg border bg-background p-2 shadow-sm">
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          <div className="flex flex-col">
                            <span className="text-[0.70rem] uppercase text-muted-foreground">Completed Tasks</span>
