    ...
    <div className="w-full p-6 mx-auto py-24">
      ...
      <section className="min-h-[30vh] flex flex-col justify-center text-center relative">
        <div className="absolute opacity-75 inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]">
          <div className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-emerald-200 dark:from-emerald-950 to-orange-200 dark:to-orange-900 opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]" />
        </div>
        <div className="space-y-4">
          ...
          <h1 className="heading vertical-gradient">
