...
This documentation site is primarily for display purposes. Here's what I used to build it: Next.js's integrated [MDX](https://nextjs.org/docs/pages/building-your-application/configuring/mdx), styled with [Tailwind Typography](https://tailwindcss.com/docs/typography-plugin#basic-usage).
